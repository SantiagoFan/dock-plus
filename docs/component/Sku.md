...
```html
  <ml-sku-spec v-model="specification" :limit="1" />
  <ml-SkuTable v-model="skus" :specification.sync="specification" :showProductNo="true" :showProductCost="true" :showEnable="true"></ml-SkuTable>
```
