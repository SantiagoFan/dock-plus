<template>
  <div class="ml-position-selector">
    ...
    <!-- 弹窗选择 -->
    <el-dialog custom-class="ml-position-selector-dialog" v-model="dialogVisible" title="选择地图" width="1000px"
      append-to-body>
      <div class="map">
        <!-- 地图 -->
...
const emit = defineEmits(['update:lng', 'update:lat', 'update:province', 'update:city', 'update:district', 'update:adcode', 'update:address', 'change'])
...
const { detail,center } =  toRefs(state)
